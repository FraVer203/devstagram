    ...
    <body class="bg-gray-100">
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between item-center">
                ...
                <!-- Aquí se válida si se inició sesión y cambia botons de login/registro por cerrar sesión -->
{{--                @if(auth()->user())--}}
{{--                    <p>Autentificado</p>--}}
{{--                @else--}}
{{--                    <p>No Autentificado</p>--}}
{{--                @endif--}}
                <!-- Manera fácil de saber si está autentificado -->
                @auth()
                    <nav class="flex gap-2 items-center">
                        ...
                        <a class="font-bold text-gray-600 text-sm" href="{{ route('posts.index', auth()->user()->username) }}">
                            Hola, <span class="font-normal">{{ ucfirst(auth()->user()->name) }}</span>
                        </a>
                        <!-- Aquí vamos a estar válidando el Cerrar la Sesión -->
        ...
        <!-- Contenio para cada una de las vistas -->
        ...
        <!-- Fin de contenio para cada una de las vistas -->
